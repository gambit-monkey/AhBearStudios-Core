...
namespace AhBearStudios.Core.Messaging.Interfaces
{
    ...
    public interface IMessageDeliveryService : IDisposable
    {
        ...
        Task<DeliveryResult> SendWithConfirmationAsync<TMessage>(TMessage message, CancellationToken cancellationToken = default) where TMessage : IMessage;
        ...
        Task<ReliableDeliveryResult> SendReliableAsync<TMessage>(TMessage message, CancellationToken cancellationToken = default) where TMessage : IReliableMessage;
        ...
        Task<BatchDeliveryResult> SendBatchAsync(IEnumerable<IMessage> messages, BatchDeliveryOptions options, CancellationToken cancellationToken = default);
        ...
        /// <summary>
        /// Event fired when a message is successfully delivered.
        /// </summary>
        ...
        /// </summary>
        event EventHandler<MessageDeliveryFailedEventArgs> MessageDeliveryFailed;
        ...
        /// <summary>
        /// Event fired when the delivery service status changes.
        /// </summary>
        event EventHandler<DeliveryServiceStatusChangedEventArgs> StatusChanged;
    }
}