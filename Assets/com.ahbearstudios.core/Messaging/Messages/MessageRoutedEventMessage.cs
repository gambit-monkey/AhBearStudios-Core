...
public readonly record struct MessageRoutedEventMessage : IMessage
{
    ...
    /// </summary>
    public ushort TypeCode { get; init; } = MessageTypeCodes.MessageBusRoutedMessage;
    ...
    /// <summary>
    /// Initializes a new instance of the MessageRoutedEventMessage struct.
    /// </summary>
    public MessageRoutedEventMessage()
    {
        Id = default;
        ...
        RoutedAt = default;
        SuccessfulRoutes = default;
        FailedRoutes = default;
        RoutingDuration = default;
        RulesEvaluated = default;
        IsFullySuccessful = default;
    ...
    /// <summary>
    /// Creates a new instance of the MessageRoutedEventMessage.
    /// </summary>
        ...
        Guid correlationId = default)
    {
        return new MessageRoutedEventMessage
        {
            ...
            Priority = MessagePriority.Low, // Routing events are informational
            CorrelationId = correlationId == default ? routedMessage?.CorrelationId ?? Guid.NewGuid() : correlationId,
            ...
            RoutingContext = routingContext?.Length <= 256 ? routingContext : routingContext?[..256] ?? string.Empty
        };
    }
}