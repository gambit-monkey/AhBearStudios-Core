...
namespace AhBearStudios.Core.Logging.Editor
{
    ...
    public class ColorizedConsoleFormatterEditor : UnityEditor.Editor
    {
        ...
        private int _selectedLevelIndex = 1; // Default to Info
        ...
        private void DrawCustomPreview()
        {
            ...
            _selectedLevelIndex = EditorGUILayout.Popup(_selectedLevelIndex, logLevelNames);
            ...
            {
                Level = (byte)_selectedLevelIndex, // Assuming log levels are 0-based indices
        ...
        private void LogToConsole(byte level, LogMessage message)
        {
            // Format the message
            string formattedMessage = _formatter.Format(message).ToString();
