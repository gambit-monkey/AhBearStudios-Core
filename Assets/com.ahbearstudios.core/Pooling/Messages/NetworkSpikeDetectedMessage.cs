...
namespace AhBearStudios.Core.Pooling.Messages
{
    ...
    /// </summary>
    public readonly record struct NetworkSpikeDetectedMessage : IMessage
    {
        /// <summary>
        ...
        /// <summary>
        /// Creates a new NetworkSpikeDetectedMessage with the specified details.
        /// </summary>
        ...
        /// <returns>New NetworkSpikeDetectedMessage instance</returns>
        public static NetworkSpikeDetectedMessage Create(
            string strategyName,
            double operationsPerSecond,
            FixedString64Bytes source = default,
            Guid correlationId = default)
        {
            return new NetworkSpikeDetectedMessage
            {
                Id = Guid.NewGuid(),
                TimestampTicks = DateTime.UtcNow.Ticks,
                TypeCode = MessageTypeCodes.NetworkSpikeDetected,
                Source = source.IsEmpty ? "AdaptiveNetworkStrategy" : source,
