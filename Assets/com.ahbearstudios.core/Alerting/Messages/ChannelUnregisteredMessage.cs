...
namespace AhBearStudios.Core.Alerting.Messages
{
    ...
    /// </summary>
    public readonly record struct ChannelUnregisteredMessage : IMessage
    {
        ...
        /// <summary>
        /// Creates a new ChannelUnregisteredMessage.
        /// </summary>
        ...
        /// <returns>New ChannelUnregisteredMessage instance</returns>
        public static ChannelUnregisteredMessage Create(
            FixedString64Bytes channelName,
            Guid correlationId = default,
            FixedString64Bytes source = default,
            FixedString512Bytes reason = default)
        {
            return new ChannelUnregisteredMessage
            {
                Id = Guid.NewGuid(),
                TimestampTicks = DateTime.UtcNow.Ticks,
                TypeCode = MessageTypeCodes.ChannelUnregistered,
