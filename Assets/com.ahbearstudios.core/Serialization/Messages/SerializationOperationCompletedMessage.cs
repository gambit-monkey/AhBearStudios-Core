...
{
    /// <summary>
    /// Message sent when a serialization operation completes successfully.
    /// Implements IMessage for integration with the messaging bus and correlation tracking.
    /// Designed for Unity game development with zero-allocation patterns.
    /// </summary>
    public readonly record struct SerializationOperationCompletedMessage : IMessage
    {
        ...
        /// <summary>
        /// Gets the serialization format that was used.
        /// </summary>
        public SerializationFormat Format { get; init; }

        /// <summary>
        /// Gets the type name that was serialized.
        /// </summary>
        ...
        /// <summary>
        /// Creates a new SerializationOperationCompletedMessage with proper validation and defaults.
        /// </summary>
        /// <param name="format">Serialization format that was used</param>
        /// <param name="typeName">Type name that was serialized</param>
        ...
        /// <returns>New SerializationOperationCompletedMessage instance</returns>
        public static SerializationOperationCompletedMessage Create(
            ...
            MessagePriority priority = MessagePriority.Normal)
        {
            ...
            var messageId = DeterministicIdGenerator.GenerateMessageId(
                messageType: "SerializationOperationCompletedMessage",
                source: sourceString,
                correlationId: null);
            ...
            return new SerializationOperationCompletedMessage
            {
                Id = messageId,
                TimestampTicks = DateTime.UtcNow.Ticks,
                TypeCode = MessageTypeCodes.SerializationOperationCompletedMessage,
        ...
        /// </summary>
        /// <returns>Serialization operation completed message string representation</returns>
        public override string ToString()
        {
            return $"SerializationOperationCompleted: {OperationType} {TypeName} using {Format} " +
                   $"({BytesProcessed} bytes, {DurationMs:F2}ms)";
        }
