...
//                 {
//                     var circuitBreakerState = _healthCheckService.GetCircuitBreakerState($"Database.{Name}");
...
//             {
//                 stopwatch.Stop();
//                 _logger.LogException($"Database health check '{Name}' failed with unexpected error", ex);
//                 
...
//             {
//                 stopwatch.Stop();
//                 _logger.LogException($"Database health check '{Name}' execution failed", ex);
//                 throw;
//             }
//         }
//
...
//                 _ => HealthCheckResult.Unhealthy(Name.ToString(), "Unknown database health status", duration, data)
//             };
//         }
//
...
//             List<(string Name, bool Success, TimeSpan Duration, string Details)> healthChecks)
//         {
//             data["FailedChecks"] = healthChecks.AsValueEnumerable().Where(c => !c.Success).ToArray();
